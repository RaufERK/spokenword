...
- Files: `/home/appuser/apps/spokenword/shared/public/audio-library/` — one file per lecture (`{stem}_64k.mp3` when encode shrinks; otherwise the original if it was already small)
