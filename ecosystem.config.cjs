...
const postDeploySteps = [
  ...
  'mkdir -p /home/appuser/apps/spokenword/shared/public/audio-library',
...
module.exports = {
  apps: [
    ...
    {
      name: 'spokenword-audio-broadcast',
      cwd: '/home/appuser/apps/spokenword/source/upload-service',
      script: '/home/appuser/apps/spokenword/source/node_modules/.bin/tsx',
      args: 'workers/audio-broadcast-watcher.ts',
      interpreter: NODE_BIN,
      exec_mode: 'fork',
      autorestart: true,
      instances: 1,
      ...
      log_date_format: 'YYYY-MM-DD HH:mm:ss Z',
      merge_logs: true,
      log_file: '/home/appuser/logs/audio-broadcast-combined.log',
      out_file: '/home/appuser/logs/audio-broadcast-out.log',
      error_file: '/home/appuser/logs/audio-broadcast-error.log',
      env: {
        NODE_ENV: 'production',
      },
      env_production: {
